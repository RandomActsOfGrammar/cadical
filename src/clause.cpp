...
Clause * Internal::new_learned_redundant_clause (int glue) {
  ...
  PROOF_TODO(proof, "-2", -2); if (proof) proof->add_derived_clause (res, false);
  assert (watching ());
  watch_clause (res);
  return res;
}
...
Clause * Internal::new_hyper_binary_resolved_clause (bool red, int glue) {
  ...
  PROOF_TODO(proof, "-3", -3); if (proof) proof->add_derived_clause (res, false);
  assert (watching ());
  watch_clause (res);
  return res;
}
...
Clause * Internal::new_hyper_ternary_resolved_clause (bool red) {
  ...
  PROOF_TODO(proof, "-4", -4); if (proof) proof->add_derived_clause (res, false);
  assert (!watching ());
  return res;
}
...
Clause * Internal::new_clause_as (const Clause * orig) {
  ...
  PROOF_TODO(proof, "-5", -5); if (proof) proof->add_derived_clause (res, false);
  assert (watching ());
  watch_clause (res);
  return res;
}
...
Clause * Internal::new_resolved_irredundant_clause () {
  ...
  PROOF_TODO(proof, "-6", -6); if (proof) proof->add_derived_clause (res, false);
  assert (!watching ());
  return res;
}
